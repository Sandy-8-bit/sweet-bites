    ...
    <div className="px-4 py-8 sm:py-16 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 overflow-hidden">
      <div className=" mx-auto">
        ...
        >
          ...
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black/80 to-primary/70 dark:from-primary-light dark:to-primary bg-clip-text text-transparent mt-3 sm:mt-4 px-4">
