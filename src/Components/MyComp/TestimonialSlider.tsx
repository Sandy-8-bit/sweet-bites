  ...
  <div className="px-4 py-8 sm:py-16 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
    <div className="mx-auto">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black/80 to-primary/70 bg-clip-text  mt-3 sm:mt-4 px-4">
        ...
        <div className="overflow-hidden relative px-2 sm:px-0">
          ...
          >
            {testimonials.map((testimonial) => (
              ...
              >
                <motion.div
                  className="relative overflow-hidden rounded-xl sm:rounded-2xl p-4 sm:p-6 h-full bg-white border border-gray-100 shadow-lg shadow-primary/5"
                  whileHover={{
                    boxShadow:
